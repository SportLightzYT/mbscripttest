...
local TogglePirateRaid = Tabs.Main:AddToggle("TogglePirateRaid", {Title = "Auto Pirate Raid", Default = false })
TogglePirateRaid:OnChanged(function(Value)
            _G.AutoPirateRaid = Value
end)
Options.TogglePirateRaid:SetValue(false)
spawn(function()
	while wait() do
						...
						if _G.AutoPirateRaid and v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
							if (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2000 then
								repeat wait()
									...
									v.HumanoidRootPart.CanCollide = false
									v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
									Tween(v.HumanoidRootPart.CFrame * F)
...
local ToggleDropFruit = Tabs.Fruit:AddToggle("ToggleDropFruit", {Title = "Auto Drop Fruit", Default = false })
...
local ToggleEspmisland = Tabs.Fruit:AddToggle("ToggleEspmisland", {Title = "ESP Mirage Island", Default = false })

ToggleEspmisland:OnChanged(function(Value)
    MirageIslandESP = Value
	UpdateIslandMirageESP()
end)
Options.ToggleEspmisland:SetValue(false)


local ToggleEspafd = Tabs.Fruit:AddToggle("ToggleEspafd", {Title = "ESP Advance Fruit Dealer", Default = false })
...
local ToggleEspmob = Tabs.Fruit:AddToggle("ToggleEspmob", {Title = "ESP Mob", Default = false })
...
local ToggleEspnpcs = Tabs.Fruit:AddToggle("ToggleEspnpcs", {Title = "ESP NPCS", Default = false })

ToggleEspnpcs:OnChanged(function(Value)
    NpcESP = Value
end)
Options.ToggleEspnpcs:SetValue(false)
spawn(function()
    while wait(1) do
        if FlowerESP then
            UpdateFlowerChams() 
